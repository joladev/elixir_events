...
if config_env() == :prod do
  ...
  config :elixir_events,
    super_user: %{
      email: System.fetch_env!("SUPER_USER_EMAIL"),
      password: System.fetch_env!("SUPER_USER_PASSWORD")
    },
    push_group: System.fetch_env!("PUSH_GROUP"),
    push_token: System.fetch_env!("PUSH_TOKEN"),
